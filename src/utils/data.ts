...
export const certifications = [
  ...
  {
    id: 5,
    title: 'Certificate of Participation — Hands-on Workshop on "Building Applications with C# and .NET Core"',
    issuer: 'Dept. of IT, DEPSTAR · CHARUSAT',
    date: 'July 7, 2025',
    description: 'Participated in a hands-on workshop on Building Applications with C# and .NET Core, conducted by Mr. Gangan Dubey (Technical Trainer, Rishabh Software) at DEPSTAR, FTE, CHARUSAT.',
